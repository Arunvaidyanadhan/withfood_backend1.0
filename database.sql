...
CREATE TABLE `recipes` (
  ...
  `IncredientsId` int NOT NULL,
  `Steps_Tips` longtext COLLATE utf8mb4_unicode_ci,
  ...
  `Tips` mediumtext COLLATE utf8mb4_unicode_ci,
  `ImagePath` longblob,
...
CREATE TABLE `ingredients` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `Measurments` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  `IsOptional` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `IsSwappable` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
